# Expense Tracker GUI version
  - This program write in Python with PyQt5 and sqlite3 database module it a program that continue from [Expense Tracker Repository](https://github.com/Bennnto/Expense_tracker)
  - Files
    1. expense_gui.py
    2. requirements.txt
  ...
  - How to use
    ...
    2. Download module by
       -```python3 -m venv venv<br>```
       -```source venv/bin/activate```
       -```pip3 install -r requirements.txt```
                       
    4. Execute python file by ```python3 expense_gui.py```
